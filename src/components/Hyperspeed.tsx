  ...
  useEffect(() => {
    ...
    class App {
      ...
      initPasses() {
        ...
        renderPass.renderToScreen = false; bloomPass.renderToScreen = false; smaaPass.renderToScreen = true;
        this.composer.addPass(renderPass); this.composer.addPass(bloomPass); this.composer.addPass(smaaPass);
      }
      loadAssets() {
        return new Promise<void>(resolve => {
          ...
          this.assets.smaa = {};
          searchImage.addEventListener('load', () => { this.assets.smaa.search = searchImage; manager.itemEnd('smaa-search'); });
          areaImage.addEventListener('load', () => { this.assets.smaa.area = areaImage; manager.itemEnd('smaa-area'); });
